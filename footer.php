            ...
            <div class="row">
              ...
              <div class="col-md-3 ml-auto">
                ...
                <ul class="list-unstyled">
                  ...
                  <li><a href="" class="smoothscroll">Testimonials</a></li>
            ...
            <form action="#" method="post" class="footer-subscribe">
              <div class="input-group mb-3">
                ...
                <div class="input-group-append">
                  <button onclick="abcd()" class="btn btn-primary text-black" type="button" id="button-addon2">Send</button>
                </div>
              </div>
            </form>
          </div>
        ...
        <div class="row pt-5 mt-5 text-center">
          <div class="col-md-12">
            <div class="border-top pt-5">
              <p>Copyright &copy;
                <script>document.write(new Date().getFullYear());</script> All rights reserved | <mark>EAZY BANK</mark> </a>
              </p>
